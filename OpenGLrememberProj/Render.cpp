...
struct point
{
	...
	point turn(const point& p) const //xOy omly
	{
		point res;
		res.z = z;
		res.x = x * p.x - y * p.y;
...
void line(point a, point b, int num)
{
	for (int i = 0; i <= num; ++i)
	{
		(a + (b - a) / num * i).AddThis();
...
void line(point a, point b, point c, int num)
{
	for (int i = 0; i <= num; ++i)
	{
...
void line(point a, point b, point c, point d, int num)
{
	for (int i = 0; i <= num; ++i)
	{
